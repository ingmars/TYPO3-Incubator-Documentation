...
project = u'TYPO3 Console'
copyright = u'2011, Oliver Hader, Jeff Segars'
...
latex_documents = [
  ('index', 'CONSOLE.tex', u'TYPO3 Console Documentation',
   u'Oliver Hader, Jeff Segars', 'manual'),
]
...
man_pages = [
    ('index', 'vfs', u'TYPO3 Console Documentation',
     [u'Oliver Hader, Jeff Segars'], 1)
]
