...
project = u'Barrierefreiheit'
copyright = u'2011, Patrick Broens'
...
latex_documents = [
  ('index', 'ACCESSIBILITY.tex', u'Accessibility Documentation',
   u'Patrick Broens', 'manual'),
]
...
man_pages = [
    ('index', 'vfs', u'Accessibility Documentation',
     [u'Patrick Broens'], 1)
]
